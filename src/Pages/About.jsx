...
const About = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-white to-rose-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 md:py-20">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        {/* Decorative Elements */}
        <div className="absolute top-10 left-10 w-20 h-20 bg-[#16a085]/20 rounded-full opacity-50 blur-xl"></div>
        <div className="absolute bottom-10 right-10 w-32 h-32 bg-[#a01631]/20 rounded-full opacity-50 blur-xl"></div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-6 -left-6 w-48 h-48 bg-[#16a085]/30 rounded-2xl blur-2xl"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Mission Card */}
            <div className="bg-gradient-to-br from-teal-50 to-teal-100 dark:from-teal-900/30 dark:to-gray-800 rounded-2xl p-8 shadow-lg border-2 border-[#16a085]/20">
              <div className="flex items-center mb-6">
                <div className="bg-[#16a085] p-4 rounded-full">
            ...
            {/* Vision Card */}
            <div className="bg-gradient-to-br from-rose-50 to-rose-100 dark:from-rose-900/30 dark:to-gray-800 rounded-2xl p-8 shadow-lg border-2 border-[#a01631]/20">
              <div className="flex items-center mb-6">
                <div className="bg-[#a01631] p-4 rounded-full">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300 border-2 border-[#16a085]/20">
              <div className="text-5xl font-bold text-[#16a085] mb-2">
                10K+
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg text-center hover:shadow-xl transition-shadow duration-300 border-2 border-[#a01631]/20">
              <div className="text-5xl font-bold text-[#a01631] mb-2">
                100K+
              </div>
      ...
      {/* Core Values */}
      <section className="py-16 px-4 bg-gradient-to-br from-[#16a085] to-[#a01631] text-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="bg-white/20 backdrop-blur-lg rounded-2xl p-8 hover:bg-white/30 transition-all duration-300 border border-white/20">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* Team Member 1 */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 border-2 border-[#16a085]/20">
              <img 
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-[#16a085] font-medium mb-2">Founder & CEO</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 border-2 border-[#16a085]/20">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-[#16a085] font-medium mb-2">Head of Design</p>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            {/* Team Member 3 */}
            <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 border-2 border-[#a01631]/20">
              <img 
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-[#a01631] font-medium mb-2">Lead Developer</p>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 border-2 border-[#a01631]/20">
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-[#a01631] font-medium mb-2">Community Manager</p>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
      ...
      <section className="py-16 px-4 bg-white dark:bg-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="border-l-4 border-[#16a085] pl-6">
            ...
            {/* Feature 3 */}
            <div className="border-l-4 border-[#a01631] pl-6">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3">
                Secure Platform
              </h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
      ...
      {/* Call to Action */}
      <section className="py-20 px-4 bg-gradient-to-r from-[#16a085] to-[#a01631]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button className="bg-white text-[#16a085] font-bold px-10 py-4 rounded-full text-lg hover:bg-gray-100 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
            Get Started Now
          </button>
        </div>
      </section>
